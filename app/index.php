...
<body>
<?php 
$str = file_get_contents('https://mail.ru/');
preg_match('/<span class="regional-info__cityselection__link__text">(.*?)<\/span>/', $str, $matches);
preg_match('/<span (.*) class="weather__temperature quotations__item__hider" (.*?)>(.*?)<\/span>/', $str, $matches2);
preg_match('/<span (.*) class="weather clearfix" (.*?) title="(.*?)">(.*?)<\/span>/', $str, $matches3);
...
<div class="wrapper">
	...
	<h1><?php echo $city; ?> погода онлайн</h1>
	<h2><?php echo $sost; ?></h2>
...
<div class="temp"><?php echo $temp; ?> &deg;C</div>
</div>
...
<div class="sun2">
	...
	<script>var scr = {"scripts":[
		...
		{"src" : "js/snowfall.jquery.min.js", "async" : false}
